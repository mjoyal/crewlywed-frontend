  ...
  return (
    <div className="avatarScore">
      {props.winner && 
        <>
        <header>
          <img className="decoration" src="images/winnerLeftDecoration.png" alt="winner decoration left"/>
          <p><span className="winnerName">{props.name}</span> wins!</p>
          <img className="decoration" src="images/winnerRightDecoration.png" alt="winner decoration right"/>
        </header>
        <footer>
